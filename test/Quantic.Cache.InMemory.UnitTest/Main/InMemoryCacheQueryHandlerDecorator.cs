...
namespace Quantic.Cache.InMemory.UnitTest
{
    public class InMemoryCacheQueryHandlerDecorator
    {
        ...
        public async Task ShouldCallHandlerWithoutCacheIfHandlerIsNotRegisteredToProvider()
        {
            ...
            var cacheQueryHandlerDecorator =  new InMemoryCacheQueryHandlerDecorator<NonRegisteredQuery, int>(mockHandler.Object, cache, queryInfoProvider);            
        ...
        public async Task ShouldThrowCacheKeyProviderTypeException()
        {
            ...
            var cacheQueryHandlerDecorator =  new InMemoryCacheQueryHandlerDecorator<WrongCacheKeyProviderQuery, string>(new WrongCacheKeyProviderQueryHandler(), cache, qip);    
        ...
        public async Task ShouldThrowCacheKeyProviderTypeExceptionIfCacheKeyProviderTypeDoesNotHavePropperConstructor()
        {
            ...
            var cacheQueryHandlerDecorator =  new InMemoryCacheQueryHandlerDecorator<CacheKeyProviderDoesNotHavePropperConstructorQuery, string>(new CacheKeyProviderDoesNotHavePropperConstructorQueryHandler(), cache, qip);            
        ...
        {
            // Arrange
            var cacheQueryHandlerDecorator =  new InMemoryCacheQueryHandlerDecorator<FooQuery, string>(new FooQueryHandler(), cache, queryInfoProvider);  
